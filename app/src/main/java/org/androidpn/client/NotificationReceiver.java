...
public final class NotificationReceiver extends BroadcastReceiver {
    ...
    public static ArrayList<PushInfoInterface> pushMsgArr=new ArrayList<PushInfoInterface>();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Constants.ACTION_SHOW_NOTIFICATION.equals(action)) {
            ...
            if(pushMsgArr!=null&&pushMsgArr.size()>0){
                for(int i=0;i<pushMsgArr.size();i++){
                    pushMsgArr.get(i).onPushMsgListener(notificationId,notificationTitle, notificationMessage, notificationUri);
                }
            }
